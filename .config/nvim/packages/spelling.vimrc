...
let g:languagetool_disable_rules='WHITESPACE_RULE,EN_QUOTES,MORFOLOGIK_RULE_EN_US,EN_QUOTES,COMMA_PARENTHESIS_WHITESPACE,UPPERCASE_SENTENCE_START,SENT_START_CONJUNCTIVE_LINKING_ADVERB_COMMA,ALL_OF_THE,IN_A_X_MANNER,SOME_OF_THE,BOTH_AS_WELL_AS,EN_UNPAIRED_BRACKETS,DOUBLE_PUNCTUATION,CURRENCY'
